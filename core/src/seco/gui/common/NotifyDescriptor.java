...
public class NotifyDescriptor extends Object {
    ...
    * @see #getValue
    */
    public NotifyDescriptor(Frame frame, Object message,
                            String title,
                            int optionType,
                            int messageType,
                            Object[] options,
    ...
    */
    public static class Message extends NotifyDescriptor
    {
        ...
        */
        public Message(Frame frame, Object message) {
        ...
        * @see NotifyDescriptor#NotifyDescriptor
        */
        public Message(Frame frame, Object message, int messageType) {
            super(
            	frame,
                message,
    ...
    */
    public static class Confirmation extends NotifyDescriptor
    {
        ...
        * @see NotifyDescriptor#NotifyDescriptor
        */
        public Confirmation(Frame frame, Object message) {
            this(frame, message, YES_NO_CANCEL_OPTION);
        }
        ...
        * @see NotifyDescriptor#NotifyDescriptor
        */
        public Confirmation(Frame frame, Object message, String title) {
            this(frame, message, title, YES_NO_CANCEL_OPTION);
        }
        ...
        * @see NotifyDescriptor#NotifyDescriptor
        */
        public Confirmation(Frame frame, Object message, int optionType) {
            this(frame, message, optionType, QUESTION_MESSAGE);
        }
        ...
        * @see NotifyDescriptor#NotifyDescriptor
        */
        public Confirmation(Frame frame, Object message, String title, int optionType) {
            this(frame, message, title, optionType, QUESTION_MESSAGE);
        }
        ...
        * @see NotifyDescriptor#NotifyDescriptor
        */
        public Confirmation(Frame frame, Object message, int optionType, int messageType) {
            super(
            		frame,
                message,
                NotifyDescriptor.getTitleForType(messageType),
        ...
        * @see NotifyDescriptor#NotifyDescriptor
        */
        public Confirmation(Frame frame, Object message, String title, int optionType, int messageType) {
            super(
               frame, message, title, optionType, messageType,
                optionType == DEFAULT_OPTION ? new Object[] { OK_OPTION } : null,
                OK_OPTION
            );
        }
    ...
    */
    public static final class Exception extends Confirmation
    {
        ...
        */
        public Exception(Frame frame, Throwable detail) {
            this(frame, detail, detail.getMessage());
    ...
    */
    public static class InputLine extends NotifyDescriptor {
        ...
        */
        public InputLine (Frame frame, final String text, final String title) {
            this(frame, text, title, OK_CANCEL_OPTION, PLAIN_MESSAGE);
        }
        ...
        */
        public InputLine (Frame frame, final String text, final String title, final int optionType,
                          final int messageType) {
            super(frame, null, title, optionType, messageType, null, null);
