...
public class FinderFactory {
    ...
    */
    ...
    public static class NextWordFwdFinder extends GenericFwdFinder {
        ...
        public NextWordFwdFinder(NotebookDocument doc, boolean stopOnEOL, boolean stopOnWhitespace) {
            this.doc = doc;
        ...
        protected int scan(char ch, boolean lastChar) {
            ...
            if (isWhitespace(ch)) { // whitespace char found
                if (stopOnWhitespace) {
                    found = true;
                    return 0;
                } else {
            ...
            if (inIdentifier) { // inside word
                if (isIdentifierPart(ch)) { // still in word
                    return 1;
                }
                found = true;
            ...
            if (inPunct) { // inside punctuation
                if (isIdentifierPart(ch)) { // a word starts after punct
                    found = true;
                    return 0;
                }
    ...
    */
    public static class PreviousWordBwdFinder extends GenericBwdFinder {
        ...
        public PreviousWordBwdFinder(NotebookDocument doc, boolean stopOnEOL, boolean stopOnWhitespace) {
            this.doc = doc;
            this.stopOnEOL = stopOnEOL;
            this.stopOnWhitespace = stopOnWhitespace;
        }
        ...
        protected int scan(char ch, boolean lastChar) {
            ...
            if (inPunct) { // inside punctuation
                if (isIdentifierPart(ch) || isWhitespace(ch) || lastChar) {
                    found = true;
                    return 1;
                }
                return -1; // still in punct
    ...
    public static class WhiteFwdFinder extends GenericFwdFinder {
        ...
        public WhiteFwdFinder(NotebookDocument doc) {
            this.doc = doc;
        }
    ...
    public static class WhiteBwdFinder extends GenericBwdFinder {
        ...
        public WhiteBwdFinder(NotebookDocument doc) {
            this.doc = doc;
        }
    ...
    public static class NonWhiteFwdFinder extends GenericFwdFinder {
        ...
        public NonWhiteFwdFinder(NotebookDocument doc) {
            this.doc = doc;
        }
    ...
    public static class NonWhiteBwdFinder extends GenericBwdFinder {
        ...
        public NonWhiteBwdFinder(NotebookDocument doc) {
            this.doc = doc;
        }
    ...
    */
    public static final class WholeWordsFwdFinder extends GenericFwdFinder
        ...
        public WholeWordsFwdFinder(NotebookDocument doc, String s, boolean matchCase) {
            this.doc = doc;
            this.matchCase = matchCase;
            chars = (matchCase ? s : s.toLowerCase()).toCharArray();
            firstCharWordPart = isIdentifierPart(chars[0]);
        }
        ...
        protected int scan(char ch, boolean lastChar) {
            ...
            if (wordFound) {
                if (isIdentifierPart(ch)) { // word continues
                    wordFound = false;
            ...
            if (stringInd == 0) { // special case for first char
                if (ch != chars[0] || insideWord) { // first char doesn't match
                    insideWord = isIdentifierPart(ch);
                    return 1;
    ...
    */
    public static final class WholeWordsBwdFinder extends GenericBwdFinder
        ...
        public WholeWordsBwdFinder(NotebookDocument doc, String s, boolean matchCase) {
            this.doc = doc;
            this.matchCase = matchCase;
            chars = (matchCase ? s : s.toLowerCase()).toCharArray();
            endInd = chars.length - 1;
            isIdentifierPart(chars[endInd]);
        }
    ...
    */
    public static final class WholeWordsBlocksFinder extends AbstractBlocksFinder {
        ...
        public WholeWordsBlocksFinder(NotebookDocument doc, String s, boolean matchCase) {
            this.doc = doc;
            this.matchCase = matchCase;
            chars = (matchCase ? s : s.toLowerCase()).toCharArray();
            firstCharWordPart = isIdentifierPart(chars[0]);
