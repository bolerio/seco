 ...
 * <br>
 * The {@link #query(CompletionResultSet, NotebookDocument, int)} abstract method
...
public abstract class AsyncCompletionQuery {
     ...
     */
    protected abstract void query(CompletionResultSet resultSet, NotebookDocument doc, int caretOffset);
     ...
     * {@link #query(CompletionResultSet, NotebookDocument, int)}
     ...
     * {@link #query(CompletionResultSet, NotebookDocument, int)} invocation.
     * <br>
