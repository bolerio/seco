...
public class HTMLToolBar extends JToolBar
{
    ...
    public void init()
    {
        ...
        add(new ToolbarButton(htmlKit.getActionByName(MyHTMLEditorKit.fontAction), "Font"));
        ...
        add(bUnderline);
        bSubscript = new MyToggleButton("bSubscript", htmlKit.getActionByName(MyHTMLEditorKit.subscriptAction), "Subscript");
        add(bSubscript);
        bSuperscript = new MyToggleButton("bSuperscript", htmlKit.getActionByName(MyHTMLEditorKit.superscriptAction), "Superscript");
        add(bSuperscript);
        bStrike = new MyToggleButton("bStrike", htmlKit.getActionByName(MyHTMLEditorKit.strikeAction), "Strike");
        add(bStrike);

        linkButton = new ToolbarButton(htmlKit.getActionByName(MyHTMLEditorKit.linkAction), "Link");
        linkButton.setName("linkButton");
        add(linkButton);

        imageButton = new ToolbarButton(htmlKit.getActionByName(MyHTMLEditorKit.imageAction), "Image");
        imageButton.setName("imageButton");
        add(imageButton);
        add(new ToolbarButton(htmlKit.getActionByName(MyHTMLEditorKit.insertSymbolAction), "Insert Special Symbol"));
        ...
        bUnorderedList = new MyToggleButton("bUnorderedList", htmlKit.getActionByName(MyHTMLEditorKit.unorderedListAction),
                "Unordered List");
        add(bUnorderedList);
        bOrderedList = new MyToggleButton("bOrderedList", htmlKit.getActionByName(MyHTMLEditorKit.orderedListAction),
                "Ordered List");
        add(bOrderedList);
        addSeparator();
        ButtonGroup alignGroup = new ButtonGroup();
        bAlignLeft = new MyToggleButton("bAlignLeft", htmlKit.getActionByName("left"), "Align Left");
        add(bAlignLeft);
        alignGroup.add(bAlignLeft);
        bAlignCenter = new MyToggleButton("bAlignCenter", htmlKit.getActionByName("center"), "Align Center");
        add(bAlignCenter);
        alignGroup.add(bAlignCenter);
        bAlignRight = new MyToggleButton("bAlignRight", htmlKit.getActionByName("right"), "bAlign Right");
        add(bAlignRight);
        alignGroup.add(bAlignRight);
        bAlignJustify = new MyToggleButton("bAlignJustify", htmlKit.getActionByName("justify"), "Align Justify");
        add(bAlignJustify);
        alignGroup.add(bAlignJustify);

        addSeparator();
        add(new ToolbarButton(htmlKit.getActionByName(MyHTMLEditorKit.indentLeftAction), "Indent Left"));
        add(new ToolbarButton(htmlKit.getActionByName(MyHTMLEditorKit.indentRightAction), "Indent Right"));
        add(new ToolbarButton(htmlKit.getActionByName(MyHTMLEditorKit.clearFormatAction), "Clear Format"));

        tableButton = new ToolbarButton(htmlKit.getActionByName(MyHTMLEditorKit.tableAction), "Table");
        add(tableButton);

        fmtTableButton = new ToolbarButton(htmlKit.getActionByName(MyHTMLEditorKit.formatTableAction), "Format Table");
        fmtTableButton.setName("fmtTableButton");
        add(fmtTableButton);
        insRowButton = new ToolbarButton(htmlKit.getActionByName(MyHTMLEditorKit.insertTableRowAction), "Insert Table Row");
        insRowButton.setName("insRowButton");
        add(insRowButton);
        insColButton = new ToolbarButton(htmlKit.getActionByName(MyHTMLEditorKit.insertTableColAction), "Insert Table Column");
    ...
    public void showAttributes(HTMLEditor editor, int p)
    {
        ...
        if (editor == null)
            return;
        AttributeSet attr = editor.getDoc().getCharacterElement(p).getAttributes();
        ...
        String align = (String) attr.getAttribute(javax.swing.text.html.HTML.Attribute.ALIGN);
        if (align == null)
        ...
        cbStyles = (cbStyles != null) ? cbStyles : (MyComboBox) getComponent("cbStyles");
        ...
        bUnorderedList = (bUnorderedList == null) ? getMyToggleButton("bUnorderedList") : bUnorderedList;
        bOrderedList = (bOrderedList == null) ? getMyToggleButton("bOrderedList") : bOrderedList;
        ...
        htmlKit.getActionByName(MyHTMLEditorKit.deleteTableRowAction).setEnabled(inTable);
        htmlKit.getActionByName(MyHTMLEditorKit.deleteTableColAction).setEnabled(inTable);
    }
    ...
    static class PBasicComboPopup extends BasicComboPopup
    {
        ...
        private Point getPopupMenuOrigin()
        {
            ...
            {
                return GUIUtil.adjustPointInPicollo((JComponent) comboBox.getParent(), new Point(0, 0));
            }
            return pt;
        }
    }
    public static class StylesAction extends AbstractAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            if (editor != null)
                editor.setAttributeSet(attr, true);
            // editor.grabFocus();
        }
    }
