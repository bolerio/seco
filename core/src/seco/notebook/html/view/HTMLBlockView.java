...
public class HTMLBlockView extends BoxView {

  private HTMLBoxPainter painter;
   ...
   */
  public HTMLBlockView(Element elem, int axis) {
    super(elem, axis);
  }
...
/*
  ...
  protected void setPropertiesFromAttributes() {
    ...
    // Reset the painter
    painter = new HTMLBoxPainter(attr); //sheet.getBoxPainter(attr);
    if (attr != null) {
