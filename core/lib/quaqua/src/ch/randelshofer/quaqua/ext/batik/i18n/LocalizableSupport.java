...
public class LocalizableSupport implements Localizable {
    ...
    /**
     * Implements {@link ch.randelshofer.quaqua.ext.batik.i18n.Localizable#setLocale(Locale)}.
     */
    public void setLocale(Locale l) {
        if (locale != l) {
            locale = l;
    ...
    /**
     * Implements {@link ch.randelshofer.quaqua.ext.batik.i18n.Localizable#getLocale()}.
     */
