 ...
 * @author boris
 */
public class NicheSelectPanel extends JPanel
{
...
//        setTitle("SECO");
    ...
    private void initComponents()
    {
        ...
        setBounds(b);
        JPanel pane = this;//(JPanel) getContentPane();
    ...
    {// GEN-FIRST:event_cmdEditNiche
        ...
        NicheEditDialog dlg = new NicheEditDialog(null, true);
