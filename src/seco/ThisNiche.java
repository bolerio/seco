...
public final class ThisNiche
{
    ...
    public static HGHandle getContextHandleFor(HGHandle entityHandle)
    {
        ...
        return h == null ? TOP_CONTEXT_HANDLE : ((ContextLink)hg.get(h)).getContext();        
    }
    ...
    /**
     * <p>Add scripting engines and default global variables to a newly created 
