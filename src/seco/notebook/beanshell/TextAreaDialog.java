...
package seco.notebook.beanshell;
...
public class TextAreaDialog extends EnhancedDialog
{
    ...
    public TextAreaDialog(Frame frame, String title, String message, Throwable t)
    {
        this(frame, title,
        message,
    ...
    {
        this(frame, name, "", UIManager.getIcon("OptionPane.errorIcon"),
        throwableToString(t));
    }
