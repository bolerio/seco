...
public class NotebookTransferHandler extends TransferHandler
{
	...
	{
		// System.out.println("exportDone: " + shouldRemove + ":" + (action ==
		// MOVE));
	...
	public static class ElementTransferable implements Transferable // extends
	// TextTransferable
	{
	...
	public static JavaStringPasteAction javaStringPasteAction = 
	    new JavaStringPasteAction();

	public static class JavaStringPasteAction extends TextAction implements UIResource
	{
