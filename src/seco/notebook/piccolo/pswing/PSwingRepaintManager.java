...
/*
 * CVS Info -
 * Filename : $Source: /home/buildspace/CodeBank/Projects/CCK/piccolo/extras/edu/umd/cs/piccolox/pswing/PSwingRepaintManager.java,v $
 * Branch : $Name:  $
    ...
    public synchronized void addInvalidComponent( JComponent invalidComponent ) {
            ...
            ( (JComponent)capturedComponent.getParent() ).getClientProperty( PSwingCanvas.SWING_WRAPPER_KEY ) != null )
        {
            ...
            Runnable validater = new Runnable() {
                public void run() {
                   // System.out.println("PSwingRepMan: " + capturedComponent);
