...
public interface IndexSearcher {
    ...
    Set<? extends Descriptor> getTypes( //Project project,
            String textForQuery,
    QuerySupport.Kind searchType,  Helper helper);

    Set<? extends Descriptor> getSymbols( //Project project, 
            String textForQuery,
     QuerySupport.Kind searchType, Helper helper);
    ...
    public abstract class Descriptor {
       public abstract ElementHandle getElement();
         ...
         */
        public abstract File getFileObject();
    ...
    public interface Helper {
        ...
        void open(File fileObject, ElementHandle element);
    }
}
