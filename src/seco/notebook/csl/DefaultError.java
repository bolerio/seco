...
public class DefaultError //implements Error 
{
    ...
    public static DefaultError createDefaultError(String key,
            String displayName,
            String description,
            int start,
            int end,
            boolean lineError,
            Severity severity) {
        return new DefaultError(key, displayName, description, start, end, lineError, severity);
    }
    ...
    public DefaultError(
             ...
             int end,
             Severity severity) {
        this(key, displayName, description, start, end, true, severity);
    }
