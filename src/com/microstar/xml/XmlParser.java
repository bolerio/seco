...
public class XmlParser {
  ...
  /**
    * Constant: the attribute value is a list of entity fontNames.
    * @see #getAttributeType
    */
...

  ...
  /**
    ...
    * of all fontNames and attribute values, so that it can test equality
...

  ...
  void initializeVariables ()
  {
    ...
    column = 0;
				...
				// Set up the buffers for data and fontNames
    dataBufferPos = 0;
  ...
  //
  // Stack of entity fontNames, to help detect recursion.
  //
  ...
  //
  // Symbol table, for internalising fontNames.
  //
